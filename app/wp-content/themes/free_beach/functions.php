...
function menu() {
  ...
  add_theme_support( 'post-thumbnails', array('post', 'Politics', 'social', 'category', 'news') );
...
function register_post_types(){
  ...
  register_post_type('news', array(
    ...
    'labels' => array(
      ...
      'not_found'          => 'Не найдена Новость', // если в результате поиска ничего не было найдено
      'not_found_in_trash' => 'Не найдена Новость в корзине', // если не было найдено в корзине
      'parent_item_colon'  => '', // для родителей (у древовидных типов)
