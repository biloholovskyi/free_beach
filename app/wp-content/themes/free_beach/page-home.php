...
<div class="container" style="border-top: 1px solid #000;">
    <div class="row">
        <div class="col-12 col-lg-9 col-md-12">
            <div class="category">
                <a href="/category.html" class="category_item">#Covid 19</a>
                <a href="#" class="category_item">#Lifestyle</a>
                <a href="#" class="category_item">#Культура</a>
                <a href="#" class="category_item">#Бизнес</a>
                <a href="#" class="category_item">#Политика</a>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-lg-7 col-md-6 col-sm-6 news_col ">
            <div class="main">
                <img class="news-img" src="<?php echo get_template_directory_uri() . '/media/image/news.png'; ?>" alt="image" >
                <div class="news-item">
                    <div class="category-name">#COVID 19</div>
                    <a href="/news.html" class="category-title">Праздник «Я выбираю небо-2020» в Казани 25 июля: программа мероприятий</a>
        ...
        <div class="col-12 col-lg-5 col-md-6 col-sm-6 news_col ">
            <div class="main">
                <img class="news-img" src="<?php echo get_template_directory_uri() . '/media/image/news1.png'; ?>" alt="image" >
                <div class="news-item">
                    <div class="category-name">#LifeStyle</div>
                    <div class="category-title">«Никто наши интересы во власти отстаивать не будет»: казанские кальянщики готовятся уйти в подполье</div>
                    <div class="cat-date">Вчера</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4 col-md-6 col-sm-6 news_col">
            <div class="main video-wrapp">
                <img class="news-img" src="<?php echo get_template_directory_uri() . '/media/image/news3.png'; ?>" alt="image">
                <div class="news-item">
                    <div class="category-name">#Культура</div>
                    <div class="category-title">Вчерашний потоп рассердил не только вас, но и прокуратуру. Идет проверка</div>
        ...
        <div class="col-12 col-lg-7 col-md-6 col-sm-6 news_col">
            <div class="main">
                ...
                <div class="news-item">
                    <div class="category-name">#COVID 19</div>
                    <div class="category-title">Праздник «Я выбираю небо-2020» в Казани 25 июля: программа мероприятий</div>
                    <div class="cat-date">Вчера</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4 col-md-6 col-sm-6 news_col">
            <div class="main">
                <img class="news-img" src="<?php echo get_template_directory_uri() . '/media/image/news5.png'; ?>" alt="image">
                <div class="news-item small-item">
                    <div class="category-name">#Культура</div>
                    <div class="category-title">В центре Казани насмерть сбили пешехода</div>
                    <div class="cat-date">12 часов назад</div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6 col-md-6 col-sm-12">
            <form class="main_form" id="form">
                ...
                <div style="margin-bottom: 32px" class="g-recaptcha" data-sitekey="6LdzuccZAAAAAFPZg0YB4_WOxOoX5aSFHs7SKw-a"></div>
